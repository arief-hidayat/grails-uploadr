...
<div class="container">
	<div class="row">
		<div class="col-md-6">
			<uploadr:addNew name="myFirstUploadr" path="${path1}" maxSize="52428800" />
		</div>
		<div class="col-md-6">
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-6">
			<uploadr:addNew name="mySecondUploadr" path="${path2}" allowedExtensions="jpg,png,gif" direction="up" maxVisible="5" unsupported="${createLink(plugin: 'uploadr', controller: 'upload', action: 'warning')}" maxSize="52428800" model="[booleanOne:true, variableTwo: 'foo', variableThree: 'bar', variableFour: 4, myObject: someObject]">
		...
		<div class="col-md-6">
			<pre class="brush:html collapse:false">
				&lt;uploadr:addNew name="mySecondUploadr" path="${path2}" allowedExtensions="jpg,png,gif" direction="up" maxVisible="5" unsupported="${createLink(plugin: 'uploadr', controller: 'upload', action: 'warning')}" model="[booleanOne:true, variableTwo: 'foo', variableThree: 'bar', variableFour: 4, myObject: someObject]">
				<g:each in="${path2.listFiles()}" var="file">
					&lt;uploadr:file name="${file.name}">
					&lt;uploadr:fileSize>${file.size()}&lt;/uploadr:fileSize>
					&lt;uploadr:fileModified>${file.lastModified()}&lt;/uploadr:fileModified>
...
<div class="container">
	<div class="row">
		<div class="col-md-6">
			<uploadr:addNew name="myThirdUploadr" path="${path3}" direction="up" maxVisible="5" maxSize="512000" rating="true" voting="true" unsupported="${createLink(plugin: 'uploadr', controller: 'upload', action: 'warning')}" maxConcurrentUploads="2" maxConcurrentUploadsMethod="pause">
...
<div class="container">
	<div class="row">
		<div class="col-md-6">
			<uploadr:addNew name="myFourthUploadr" path="${path4}" maxVisible="5" rating="true" voting="true" colorPicker="true" maxSize="52428800">
		...
		<div class="col-md-6">
			<pre class="brush:html collapse:false">
				&lt;uploadr:addNew name="myFourthUploadr" path="${path4}" maxVisible="5" rating="true" voting="true" colorPicker="true">
				<g:each in="${path4.listFiles()}" var="file">
					&lt;uploadr:file name="${file.name}">
					&lt;uploadr:fileSize>${file.size()}&lt;/uploadr:fileSize>
					&lt;uploadr:fileModified>${file.lastModified()}&lt;/uploadr:fileModified>
...
<div class="container">
	<div class="row">
		<div class="col-md-6">
			<uploadr:addNew name="myFifthUploadr" path="${path5}" direction="up" class="demo" placeholder="Behold: the drop area!" fileselect="Behold: the fileselect!" maxVisible="4" noSound="true" maxSize="52428800">
		...
		<div class="col-md-6">
			<pre class="brush:html collapse:false">
				&lt;uploadr:addNew name="myFifthUploadr" path="${path5}" direction="up" rating="true" class="demo" placeholder="Behold: the drop area!" fileselect="Behold: the fileselect!" maxVisible="4" noSound="true">
				<g:each in="${path5.listFiles()}" var="file">
					&lt;uploadr:file name="${file.name}">
					&lt;uploadr:fileSize>${file.size()}&lt;/uploadr:fileSize>
					&lt;uploadr:fileModified>${file.lastModified()}&lt;/uploadr:fileModified>
